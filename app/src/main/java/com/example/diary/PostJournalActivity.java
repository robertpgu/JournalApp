...
public class PostJournalActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thoughtsEditText = findViewById(R.id.post_description_id);
    ...
    private void saveJournal() {
        ...
        && imageUri != null) {
            ...
            final StorageReference filepath = storageReference //.../journal_images/image.jpeg
                    .child("journal_images")
                    .child("my_image" + Timestamp.now().getSeconds()); // my_image_151234154
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == GALLERY_CODE && resultCode == RESULT_OK){
            if(data != null){
                imageUri = data.getData(); // path to the image
